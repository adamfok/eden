...
class ExampleUI(QtWidgets.QDialog):
    ...
    def __init__(self, ui_path=None, parent=maya_main_window()):
        ...
        # Set Title
        self.setWindowTitle("Example UI")
    ...
    def init_ui(self, ui_path=None):
        if not ui_path:
            ui_path = "(0)/example_ui.ui".format(os.path.dirname(__file__))
